                    ...
                    <div class="page-banner__wrapper">
                        <div class="container">
                            ...
                            <div class="page-breadcrumb">
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="dashboard-all-course.php">Courses</a></li>
                                        ...
                                        <div class="tutor-course-price-preview__meta">
                                            ...
                                            <div class="tutor-course-price-preview__btn">
                                                <form method="post" action="apply.php">
                                                    ...
                                                    <button type="submit" class="btn btn-primary btn-hover-secondary w-100">
                                                        <i class="fas fa-shopping-basket"></i> Apply
                                                    </button>
                                                </form>
                                            </div>
                                        </div>

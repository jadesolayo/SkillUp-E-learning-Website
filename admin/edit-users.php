...
if (isset($_GET['id'])) {
    ...
    if ($user) {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (isset($_POST['update'])) {
                ...
                $updated = updateuser($userId, $firstname, $lastname, $email);
    ...
    // No user ID provided, redirect to an error page or display a message
...
<body class="dashboard-page dashboard-nav-fixed">
    ...
    <main class="dashboard-main-wrapper">
        ...
        <div class="dashboard-content">
            <div class="container">
                <h4 class="dashboard-title">Edit user</h4>
                            ...
                            <form method="POST">
                                ...
                                <div class="col-md-12 py-2">
                                    <div class="dashboard-content__input">
                                        ...
                                        <input name="firstname" type="text" class="form-control" value="<?php echo $user['user_firstname']; ?>">
                                    </div>
                                </div>
                                <div class="col-md-12 py-2">
                                    <div class="dashboard-content__input">
                                        <label class="form-label-02">Last Name</label>
                                        <input name="lastname" type="text" class="form-control" value="<?php echo $user['user_lastname']; ?>">
                                    </div>
                                </div>
                                <div class="col-md-12 py-2">
                                    <div class="dashboard-content__input">

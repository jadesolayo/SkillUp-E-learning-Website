      ...
      <div class="row gy-6">
        <div class="col-lg-4">
          ...
          <div class="footer-widget">
            <a href="#" class="footer-widget__logo"><img src="assets/images/logo.png" alt="Logo" width="150"
                height="32" /></a>
    ...
    <div class="container">
      <div class="copyright-wrapper text-center">
        ...
        <p class="footer-widget__copyright mt-0">
          &copy;
          <?php echo date('Y') ?> <span> SkillUp by Jade</span>
        </p>
      </div>
    </div>
  </div>

            ...
            <div class="header-top-bar-wrap d-sm-flex justify-content-between">
              <div class="header-top-bar-wrap__info">
                <ul class="header-top-bar-wrap__info-list">
                  ...
                  <li>
                    <a href="mailto:agency@example.com"
          ...
          <div class="container">
            ...
            <div class="header-main-wrapper">
              ...
              <div class="header-logo">
                <a class="header-logo__logo" href="index.php"
                  ><img
                  ...
                  <ul class="header-category-dropdown">
                    <li>
                      ...
                      <ul class="sub-categories children">
                        ...
                        <li>
                          <a href="#"
                            >Communications<span class="toggle-sub-menu"></span
                          ></a>

                          <ul class="course-list children">
                            <li>
                              <a
                                class="categories-course"
                                href="shop-single-list-left-sidebar.html"
                              >
                                ...
                                <div class="categories-course__caption">
                                  ...
                                  <div class="categories-course__price">
                                    ...
                                    >
                                    <span
                                      class="categories-course__regular-price"
                                      >$30.00</span
                                    >
                                  </div>
                                </div>
              ...
              <div class="header-inner">
                ...
                <div class="header-serach">
                  <form action="#">
                    <input
                      type="text"
                      class="header-serach__input"
                      placeholder="Search..."
                    />
                    <button class="header-serach__btn">
                      ...
                      <li class="header-mini-cart__item">
                        ...
                        <div class="header-mini-cart__caption">
                          <h3 class="header-mini-cart__name">
                            <a href="shop-single-list-left-sidebar.html"
                              >Awesome for Websites</a
                            >
                          </h3>
                          <span class="header-mini-cart__quantity"
                            >1 × <strong class="amount">$49</strong
                            ><span class="separator">.00</span></span
                          >
                        </div>
                      </li>
                      <li class="header-mini-cart__item">
                ...
                <div class="header-toggle">
                  <button
                    class="header-toggle__btn d-xl-none"
                  ...
                  <button
                    class="header-toggle__btn search-open d-flex d-md-none"
                  >

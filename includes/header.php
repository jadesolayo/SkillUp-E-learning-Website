    ...
    <div class="container">
      ...
      <div class="header-main-wrapper">
        ...
        <div class="header-logo">
          <a class="header-logo__logo" href="index.php"><img src="assets/images/logo.png" width="296" height="64"
              alt="Logo"></a>
        </div>
        <!-- Header Logo End -->
        ...
        <div class="header-category-menu d-none d-xl-block">
          ...
          <div class="header-category-dropdown-wrap">
            <ul class="header-category-dropdown">
              <li>
                <a href="shop-left-sidebar.php"> Design <span class="toggle-sub-menu"></span></a>

                <ul class="sub-categories children">
                  <li><a href="shop-left-sidebar.php">All Business</a></li>
                  <li>
                    <a href="#">Communications<span class="toggle-sub-menu"></span></a>

                    <ul class="course-list children">
                      <li>
                        <a class="categories-course" href="shop-single-list-left-sidebar.php">
                  ...
                  <li><a href="shop-left-sidebar.php">Entrepreneurship</a></li>
                  <li><a href="shop-left-sidebar.php">Finance</a></li>
                  <li><a href="shop-left-sidebar.php">Management</a></li>
                  <li><a href="shop-left-sidebar.php">Sales</a></li>
                  <li><a href="shop-left-sidebar.php">Strategy &amp; Analytics</a></li>
                </ul>
              </li>
              <li><a href="shop-left-sidebar.php">Business</a></li>
              <li><a href="shop-left-sidebar.php">Data Science</a></li>
              <li><a href="shop-left-sidebar.php">Development</a></li>
              <li><a href="shop-left-sidebar.php">Finance</a></li>
              <li><a href="shop-left-sidebar.php">Health &amp; Fitness</a></li>
              <li><a href="shop-left-sidebar.php">Lifestyle</a></li>
              <li><a href="shop-left-sidebar.php">Marketing</a></li>
              <li><a href="shop-left-sidebar.php">Music</a></li>
              <li><a href="shop-left-sidebar.php">Personal Development</a></li>
              <li><a href="shop-left-sidebar.php">Photography</a></li>
              <li><a href="shop-left-sidebar.php">Teaching &amp; Academics</a></li>
            </ul>
          </div>
        </div>
                        ...
                        <div class="row">
                          <div class="col-xl-3">
                            <div class="menu-content-list">
                              <a href="index.php" class="menu-content-list__link">Main Demo <span
                                  class="badge hot">Hot</span></a>
                              <a href="index-course-hub.php" class="menu-content-list__link">Course Hub</a>
                              <a href="index-online-academy.php" class="menu-content-list__link">Online Academy <span
                                  class="badge hot">Hot</span></a>
                              <a href="index-university.php" class="menu-content-list__link">University</a>
                              <a href="index-education-center.php" class="menu-content-list__link">Education Center
                                <span class="badge hot">Hot</span></a>
                            </div>
                          </div>
                          <div class="col-xl-3">
                            <div class="menu-content-list">
                              <a href="index-language-academic.php" class="menu-content-list__link">Language
                                Academic</a>
                              <a href="index-single-instructor.php" class="menu-content-list__link">Single
                                Instructor</a>
                              <a href="index-dev.php" class="menu-content-list__link">Dev <span
                                  class="badge new">New</span></a>
                              <a href="index-online-art.php" class="menu-content-list__link">Online Art <span
                                  class="badge new">New</span></a>
                            </div>
                          </div>
                          <div class="col-xl-6">
              ...
              <ul class="header-mini-cart__product-list ">
                <li class="header-mini-cart__item">
                  ...
                  <div class="header-mini-cart__thumbnail">
                    <a href="shop-single-list-left-sidebar.php"><img src="assets/images/product/product-1.png"
                        alt="Product" width="80" height="93"></a>
                  </div>
                  <div class="header-mini-cart__caption">
                    <h3 class="header-mini-cart__name"><a href="shop-single-list-left-sidebar.php">Awesome for
                        Websites</a></h3>
                ...
                <li class="header-mini-cart__item">
                  <a href="#" class="header-mini-cart__close"></a>
                  <div class="header-mini-cart__thumbnail">
                    <a href="shop-single-list-left-sidebar.php"><img src="assets/images/product/product-2.png"
                        alt="Product" width="80" height="93"></a>
                  </div>
                  <div class="header-mini-cart__caption">
                    <h3 class="header-mini-cart__name"> <a href="shop-single-list-left-sidebar.php">Awesome for
                ...
                <li class="header-mini-cart__item">
                  <a href="#" class="header-mini-cart__close"></a>
                  <div class="header-mini-cart__thumbnail">
                    <a href="shop-single-list-left-sidebar.php"><img src="assets/images/product/product-3.png"
                        alt="Product" width="80" height="93"></a>
                  </div>
                  <div class="header-mini-cart__caption">
                    <h3 class="header-mini-cart__name"> <a href="shop-single-list-left-sidebar.php">Awesome for

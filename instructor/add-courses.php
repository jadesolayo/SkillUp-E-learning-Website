...
if (isset($_POST['submit'])) {
    ...
    $courseImages = $_FILES['courseimage'];

    $response = addCourse($courseTitle, $courseDescription, $courseCategory, $coursePrice, $courseDuration, $courseImages);
}
?>
...
<body class="dashboard-page dashboard-nav-fixed">
    ...
    <main class="dashboard-main-wrapper">
        ...
        <div class="dashboard-content">
            <div class="container">
                <h4 class="dashboard-title">Add a New Course</h4>
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12 py-2">
                                    <div class="dashboard-content__input">
                                        ...
                                        <textarea name="course-description" type="text" class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12 py-2">
                                    <div class="dashboard-content__input">
                                ...
                                <div class="col-md-12 py-2">
                                    <div class="dashboard-content__input">
                                        ...
                                        <input name="course-price" type="text" class="form-control" value="$">
                                    </div>
                                </div>
                                <div class="col-md-12 py-2">
                                    <div class="dashboard-content__input">
                                        <label class="form-label-02">Duration</label>
                                        <input name="course-duration" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12 py-2">
                                    <div class="dashboard-content__input">
                                ...
                                <div class="dashboard-settings__btn">
                                    <button name="submit" class="btn btn-primary btn-hover-secondary">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>

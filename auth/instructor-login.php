...
if (isset($_POST['login'])) {
    $response = loginInstructor($_POST['username'], $_POST['password']);
}
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        ...
                        <figure><img src="../assets/images/Professor.png" alt="signin image"></figure>
                        <a href="../auth/instructor-register.php" class="signup-image-link">Create an account</a>
                    </div>

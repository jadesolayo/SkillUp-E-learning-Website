...
if (isset($_POST['register'])) {
    $response = registerAdmin($_POST['firstname'], $_POST['lastname'], $_POST['username'], $_POST['email'], $_POST['password'], $_POST['confirm_password']);
}
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container">
                <div class="signup-content">
                    ...
                    <div class="signup-image">
                        ...
                        <a href="../auth/admin-login.php" class="signup-image-link">Already have an account? Login</a>
                    </div>
                </div>
            </div>
        </section>
